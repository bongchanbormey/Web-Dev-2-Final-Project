...
document.querySelector("form").addEventListener("submit", function(event) {
    ...
    const zipCode = document.querySelector("#zip-code"); // Assuming the input has an ID
    ...
    const cvv = document.querySelector("#cvv"); // Assuming the input has an ID
    ...
    const cardNumber = document.querySelector("#card-number"); // Assuming the input has an ID
    ...
    const expYear = document.querySelector("#exp-year"); // Assuming the input has an ID
    ...
    const country = document.querySelector("#country-dropdown"); // Assuming the select has an ID
